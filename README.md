...
- The Nodes: You divide this chunk into small, fixed-size units.The Trick: When a block is not in use, you use the memory inside that block to store a pointer to the next free block. 
