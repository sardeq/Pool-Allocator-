...
- This costs zero overhead because you reuse the empty memory itself.
- This makes allocation and deallocation extremely fast (O(1) complexity) because you are simply pushing and popping from a linked list.
